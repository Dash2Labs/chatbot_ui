...
export const Default: Story = {
  args: {
    ...
    aiName: "AI",
    aiProfileImage:
      "https://cdn.pixabay.com/photo/2013/07/13/13/41/robot-161367_1280.png",
    ...
    onHistoryScroll: (event) =>
      console.log(
        `History Scroll: ScrollTop is ${event.currentTarget.scrollTop}`
      ),
    ...
    onGuestLogin: () => alert("Guest login"),
...
export const LongChatHistory: Story = {
  args: {
    history: [
      {
        title: "Chat 1",
        timeStamps: "2023-11-10 09:00 AM",
        isActive: false,
        sessionId: "1234567890",
      },
      {
        title: "Chat 2",
        timeStamps: "2023-11-11 11:00 AM",
        isActive: true,
        sessionId: "1234567890",
      },
    ],
    ...
    history: [
      {
        ...
        timeStamps: "2023-11-12 03:00 PM",
        isActive: true,
        sessionId: "1234567890",
      },
    ],
